...
from lib.sqlalchemy_declarative import db_connect, fitbod, fitbod_muscles
import configparser
import math
from datetime import datetime, timedelta, date
import operator

layout = html.Div(id='lifting-canvas', children=[
...
@dash_app.callback([Output('exercise-containers', 'children'),
