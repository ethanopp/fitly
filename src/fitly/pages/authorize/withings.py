...
from ...api.withingsAPI import withings_connected, connect_withings_link
from oura import OuraOAuth2Client
from ...api.withingsAPI import save_withings_token
import configparser
import re
import time
...
@app.callback(Output('withings-token-refresh', 'children'),
                   [Input('url', 'search')],
                   [State('url', 'pathname')])
