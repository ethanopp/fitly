...
from ...api.stravaApi import get_strava_client, save_strava_token, connect_strava_link, get_strava_client, strava_connected
import configparser
import re
import time
from ..app import app
...
@app.callback(Output('strava-token-refresh', 'children'),
                   [Input('url', 'search')],
                   [State('url', 'pathname')])
